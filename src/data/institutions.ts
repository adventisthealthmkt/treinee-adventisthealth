...
export const clinics: Institution[] = [
  {
    ...
    services: "Atendimento baseado em APS com assistência médica e multiprofissional, Foco em cuidado integral, longitudinal e contínuo, PA Digital 24/7, Casos identificados são estabilizados e encaminhados para hospital de alta complexidade",
    beds: "N/A",
    employees: PLACEHOLDER,
    website: PLACEHOLDER,
    socialMedia: PLACEHOLDER,
  ...
  },
  {
    ...
    complexityLevel: "Atenção Primária à Saúde - APS",
    specialties: "Medicina de Família, Enfermagem de Família, Psicologia, Nutrição, Fisioterapia",
    services: "Atendimento baseado em APS com assistência médica e multiprofissional, Foco em cuidado integral, longitudinal e contínuo, PA Digital 24/7, Casos identificados são estabilizados e encaminhados para o Hospital Adventista Belém",
    beds: "N/A",
    employees: PLACEHOLDER,
    website: PLACEHOLDER,
    socialMedia: PLACEHOLDER,
