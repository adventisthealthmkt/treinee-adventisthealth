...
export const hospitals: Institution[] = [
  ...
  {
    name: "Hospital Adventista Pênfigo Matriz",
    type: "hospital",
    city: "Campo Grande",
    state: "MS",
    yearFounded: "1950",
  ...
  {
    name: "Hospital Adventista Pênfigo Centro",
    type: "hospital",
    city: "Campo Grande",
    state: "MS",
    ...
    technicalDirector: PLACEHOLDER,
    complexityLevel: "Alta complexidade",
    specialties: "Integrado ao Hospital Adventista Pênfigo Matriz",
    beds: "Integrado ao Hospital Adventista Pênfigo Matriz",
    employees: "Integrado ao Hospital Adventista Pênfigo Matriz",
    website: PLACEHOLDER,
    socialMedia: PLACEHOLDER,
    socialProjects: PLACEHOLDER,
  },
