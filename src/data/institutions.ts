...
export const hospitals: Institution[] = [
  ...
  },
  {
    name: "Hospital Adventista Pênfigo",
    type: "hospital",
    city: "Campo Grande - Centro",
    state: "MS",
    yearFounded: PLACEHOLDER,
    technicalDirector: PLACEHOLDER,
    complexityLevel: "Alta complexidade",
    specialties: "Integrado ao Hospital Adventista Pênfigo",
    beds: "Integrado ao Hospital Adventista Pênfigo",
    employees: "Integrado ao Hospital Adventista Pênfigo",
    website: PLACEHOLDER,
    socialMedia: PLACEHOLDER,
    socialProjects: PLACEHOLDER,
  },
