    ...
    <section id="rede" className="section-padding bg-background">
      <div className="section-container">
        ...
        <div className="text-center max-w-3xl mx-auto mb-10 md:mb-16">
          ...
          <h2 className="text-2xl md:text-4xl lg:text-5xl font-bold text-foreground mb-4">Nossa rede pelo Brasil
        ...
        {/* Full-width Map */}
        <div className="relative w-full aspect-[16/10] md:aspect-[16/9] rounded-2xl md:rounded-[28px] overflow-hidden p-2 md:p-3.5 bg-gradient-to-br from-[hsl(var(--primary-light))] to-[hsl(var(--accent))] shadow-[0_10px_30px_rgba(0,0,0,0.12),inset_0_0_0_1px_rgba(255,255,255,0.35)] md:shadow-[0_20px_40px_rgba(0,0,0,0.18),inset_0_0_0_1px_rgba(255,255,255,0.35)] mb-8 md:mb-12">
          <iframe
