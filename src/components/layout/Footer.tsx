        ...
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            <a href="https://adventisthealth.com.br" target="_blank" rel="noopener noreferrer" className="block mb-4">
              <img src={logoAHB} alt="Adventist Health Brasil" className="h-24 md:h-28 w-auto" />
            </a>
          ...
          {/* Contact */}
          <div>
            <h4 className="font-semibold mb-4 text-primary-foreground">Parcerias Acadêmicas</h4>
            <p className="text-primary-foreground/70 text-sm leading-relaxed mb-4">
              Interessado em parcerias educacionais, estágios ou programas trainee?
            </p>
            <a href="#contato" className="inline-flex items-center gap-2 text-sm font-medium text-primary-foreground hover:underline">
              Entre em contato →
            </a>
          </div>
        </div>
